    ...
    <AdminLayout>
      <div className="p-6 lg:p-8 space-y-6">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: mfg }}>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <select value={severityFilter} onChange={(e) => setSeverityFilter(e.target.value)}
            className="h-10 px-3 rounded-lg border text-sm" style={{ background: card, borderColor: border, color: fg }}>
        ...
        <div className="rounded-xl border overflow-hidden" style={{ background: card, borderColor: border }}>
          <div className="overflow-x-auto">
            <table className="w-full min-w-[800px]">
              ...
              <tbody>
                {filtered.map((log) => (
                  <tr key={log.id} className="border-b last:border-0 hover:bg-gray-50/5 transition-colors" style={{ borderColor: border }}>
                    ...
                    <td className="px-4 py-3 text-[10px] font-mono" style={{ color: mfg }}>{log.pealmorRef}</td>
                  </tr>
                ))}
              </tbody>
            </table>
